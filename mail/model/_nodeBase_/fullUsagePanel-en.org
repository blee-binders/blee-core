...
** |B
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Gnus Profile specification" :anchor "" :extraInfo "Design In progress"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Gnus Profile specification:* |]]  Design In progress  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
**
** B|
